...
SRCREV_tcc805x = "cf2287f4e5d2794ac2c80bca903e58d003f14bcd"
...
do_install_tcc805x() {
	...
	tools/tcc805x_snor_mkimage/tcc805x-snor-mkimage -i ${WORKDIR}/micom.cfg -o ${D}/boot-firmware/${CHIP_NAME}_snor.cs.rom
}
